...
const CryptoAssetComponent = (props) => {
    ...
    const [asset, setAsset] = useState({data: {"crypto_currency": {}}, price: 0});
    ...
    const showEditTransactionModal = (transactionID, type, amount, datetime) => {
            ...
            <tr key={transactionID} className="crypto-transaction table-text crypto-transaction-row clickable-row"
                ...
                <td className="text-end">
                    <div className="d-flex justify-content-end">
                        {sign}{(amount * price).toFixed(2)}$
                    </div>
                    <div className="d-flex justify-content-end">
                        <small style={{color: color}}>{sign}{amount} {asset.data["crypto_currency"]["code"]}</small>
                    </div>
                </td>
            </tr>
        );
        ...
        <Container>
            <Container>
                ...
                <div className="d-flex justify-content-start">
                    <h3>{(asset.data["amount"] * asset.price).toFixed(2)} $</h3>
                </div>
